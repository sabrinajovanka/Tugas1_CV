<html>
    ...
    <body class="antialiased">
        ...
        <header style="text-align: center;">
            <h1>Pengalaman</h1>
            <img src="pengalaman.png" width="200" height="200" style="border-radius: 50%;"/>
          </header>
          <div class="contpengalaman">
            <div>
                <h4>Mentor of Information Systems Study Program</h4>
                <h5>2021-2022</h5>
            </div>
            <div>
                <h4>Vice Coordinator of POGA Club</h4>
                <h5>2022-present</h5>
            </div>
          </div>
    </body>
